...
public class RMatrix {
    ...
    public RVector.View getRow(int row) {
        return new RVector.View(this.getColumnCount(), column -> this.get(row, column), (column, value) -> this.set(row, column, value));
    }

    public RVector.View getColumn(int column) {
        return new RVector.View(this.getRowCount(), row -> this.get(row, column), (row, value) -> this.set(row, column, value));
    }
    ...
    public String toString() {
        ...
        RVector.View[] rows = this.getRows();
        for (int i = 0; i < rows.length; ++i) {
    ...
    public static interface Mapper {
        public Real getNewValue(int var1, int var2, Real var3);

        default public RVector.Mapper forRow(int row) {
            return (index, oldValue) -> this.getNewValue(row, index, oldValue);
        }

        default public RVector.Mapper forColumn(int column) {
    ...
    public static interface Generator {
        public Real getValue(int var1, int var2);

        default public RVector.Generator forRow(int row) {
            return index -> this.getValue(row, index);
        }

        default public RVector.Generator forColumn(int column) {
    ...
    extends RMatrix {
        ...
        public static interface Setter {
            public void set(int var1, int var2, Real var3);
        }
    }
}
