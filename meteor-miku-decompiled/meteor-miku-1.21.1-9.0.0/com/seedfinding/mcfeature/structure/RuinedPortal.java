...
extends UniformStructure<RuinedPortal>
implements ILoot {
    public static final VersionMap<RegionStructure.Config> OVERWORLD_CONFIGS = new VersionMap<RegionStructure.Config>().add(MCVersion.v1_16, new RegionStructure.Config(40, 15, 34222645));
    public static final VersionMap<RegionStructure.Config> NETHER_CONFIGS = new VersionMap<RegionStructure.Config>().add(MCVersion.v1_16, new RegionStructure.Config(25, 10, 34222645));
    private final Dimension dimension;

    public RuinedPortal(Dimension dimension, MCVersion version) {
        this(dimension, RuinedPortal.getConfigs(dimension).getAsOf(version), version);
    }
    ...
    public static VersionMap<RegionStructure.Config> getConfigs(Dimension dimension) {
        ...
        return new VersionMap<RegionStructure.Config>();
    }
